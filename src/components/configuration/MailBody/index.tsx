            ...
            {selected == 0 ? (
              <FormGroup legendText="">
                <FormField>
                  ...
                  <ErrorMessage
                    invalid={Boolean(touched.senderId && errors.senderId)}
                    invalidText={errors.senderId}
                  />
                </FormField>{' '}
                <FormField>
                  <FormContainer>
                  ...
                  <ErrorMessage
                    ...
                    invalidText={errors.templateBody}
                  />
                </FormField>
              </FormGroup>
            ) : (
              <FormGroup legendText="">
                <FormField>
                  ...
                  <ErrorMessage
                    ...
                    invalidText={errors.templatename}
                  />
                </FormField>
                <FormField>
                  <FormContainer>
                  ...
                  <ErrorMessage
                    invalid={Boolean(
                      touched.emailcontainer && errors.emailcontainer
                    )}
                    invalidText={errors.emailcontainer}
                  />
                </FormField>
                <FormField>
                  <FormContainer>
                    <Field name="emailcontent">
                      {({ field }: any) => <RichTextExample />}
                    </Field>
                  </FormContainer>
                  <ErrorMessage
                    invalid={Boolean(
                    ...
                    invalidText={errors.emailcontent}
                  />
                </FormField>
              </FormGroup>
            )}
...
const MailNavItem = styled.div<HeaderNavItemProps>`
  ...
  color: ${({ selected, theme }) =>
    selected ? theme.colors.white : theme.colors.lightText};
  background-color: ${({ selected, theme }) =>
    selected ? theme.colors.bgPrimaryLight : theme.colors.bgHover};
